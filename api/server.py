...
def bad_request(e):
    ...
    return "<h1>Missing parameters</h1><p>You <strong>must</strong> specify lat and lon</p></br><p>Usage:</br>url/predict?lat=<XXXX:float>&lon=<YYYY:float></p>", 400

@app.errorhandler(406)
def not_acceptable(e):
    return "<h1>Wrong parameters</h1><p>Lat and lon parameters should be <strong>numeric</strong> values</p></br><p>Usage:</br>url/predict?lat=<XXXX:float>&lon=<YYYY:float></p>", 406
